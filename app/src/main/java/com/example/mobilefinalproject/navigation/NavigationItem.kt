...
sealed class NavigationItem(val route:String) {
    ...
    data object Checkout : NavigationItem(Screen.CHECKOUT.name)
    data object Review : NavigationItem(Screen.REVIEW.name)
    data object RecentLessons : NavigationItem(Screen.RECENT_LESSONS.name)
}